...
class BesselBasisLayer(torch.nn.Module):
    """Fixed BesselBasisLayer that avoids the torch.arange out= compatibility issue."""
    ...
    def __init__(self, num_radial, cutoff=5.0, envelope_exponent=5):
        ...
        # Create frequency tensor without using out= parameter
        self.register_buffer('freq', torch.arange(1, num_radial + 1).float() * math.pi)

    def reset_parameters(self):
        # No need to reset freq since it's a buffer
        pass
...
class Envelope(torch.nn.Module):
    """Envelope function for smooth cutoff."""
